...
public class QuestionController {
    ...
    @PostMapping("/create")
    @PreAuthorize("isAuthenticated()")
    public String questionUpdate(@Valid QuestionForm questionForm, BindingResult bindingResult, Principal principal) {
    ...
    public String questionDelete(Principal principal, @PathVariable int id) {
        Question question = questionService.getQuestion(id);
        if (!question.getAuthor().getUsername().equals(principal.getName())) {
